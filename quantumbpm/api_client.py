...
from quantumbpm.api_response import ApiResponse, T as ApiResponseT
import quantumbpm.models
from quantumbpm import rest
from quantumbpm.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(quantumbpm.models, klass)
